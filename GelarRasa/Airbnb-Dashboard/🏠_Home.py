...
listings = pd.read_parquet(r'.\Airbnb-Dashboard\listings.parquet')
reviews = pd.read_parquet(r'.\Airbnb-Dashboard\reviews.parquet')
hosts = pd.read_parquet(r'.\Airbnb-Dashboard\hosts.parquet')
